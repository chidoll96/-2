...
namespace BitScience
{
    public class StreetViewCube : MonoBehaviour
    {
        ...
        private IEnumerator DownloadStreetView()
        {
            ...
            //string ExampleUrl = "https://maps.googleapis.com/maps/api/streetview?size=512x512&location=37.36689,126.8122&fov=180&heading=270&pitch=0&key=AIzaSyBnXl_I3__51pnLApeqG_NXzYmaI_OE07Q";
